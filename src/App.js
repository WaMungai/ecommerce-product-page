    ...
    <>
      ...
      <section className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:place-items-center lg:py-20">
            ...
            {products.map((item, index) => (
              ...
              >
                <img
                  src={item.mainImage}
                  alt=""
                  className={() => setShowLightbox(true)}
                />
        ...
        <article className="px-8 pb-10">
          <h2 className="bg=slate-100 py-1 px-2 text-orange-400 uppercase tracking-wide text-sm font-bold incline-block rounded shadow mb-10 ">
            Sneaker Company
          </h2>
